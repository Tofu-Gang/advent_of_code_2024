...
def puzzle_01() -> int:
    ...
    :return: Take a look at the little Elf's word search. How many times does
    XMAS appear?
    """
...
def puzzle_02() -> int:
    ...
    :return: Flip the word search from the instructions back over to the word
    search side and try again. How many times does an X-MAS appear?
    """

    return WordPuzzle().x_word_search()
