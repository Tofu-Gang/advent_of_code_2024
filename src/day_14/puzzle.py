...
from .bathroom_hall import BathroomHall
...
def puzzle_01() -> int:
    ...
    :return: Predict the motion of the robots in your list within a space which
    is 101 tiles wide and 103 tiles tall. What will the safety factor be after
    exactly 100 seconds have elapsed?
    """

    bathroom_hall = BathroomHall()
    bathroom_hall.move_robots(GOAL_SECONDS)
    return bathroom_hall.safety_factor
...
def puzzle_02() -> int:
    ...
    :return: What is the fewest number of seconds that must elapse for the
    robots to display the Easter egg?
    """

    bathroom_hall = BathroomHall()
    bathroom_hall.move_robots(EGG_SECONDS)
    bathroom_hall.print_hall()
    return EGG_SECONDS
